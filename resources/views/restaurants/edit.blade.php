...
<body>
    <div class="container">
        ...
        {{ HTML::ul($errors->all()) }} {{ Form::model($restaurants, array('route' => array('restaurants.update', $restaurants->id), 'method' => 'PUT')) }}
        ...
        <div class="form-group">
            {{ Form::label('numberofseats', 'Number seats in the restaurant') }} {{ Form::text('numberofseats', Input::old('numberofseats'), array('class' => 'form-control')) }}
        </div>
        <div class="form-group">
        ...
        {{ Form::submit('Edit the Restaurant!', array('class' => 'btn btn-primary')) }} {{ Form::close() }}
    </div>
</body>
